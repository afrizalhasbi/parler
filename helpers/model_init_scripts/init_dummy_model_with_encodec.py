...
if __name__ == "__main__":
    ...
    encodec_version = "facebook/encodec_48khz"
    ...
    model.save_pretrained(os.path.join(args.save_directory))

    prompt_tokenizer = AutoTokenizer.from_pretrained(
        text_model,
    )
    
    model.push_to_hub("feedloop-ai/fl-parler-240M", private=True)
    prompt_tokenizer.push_to_hub("feedloop-ai/fl-parler-240M", private=True)
